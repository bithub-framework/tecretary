...
export declare class TradeGroupReader<H extends HLike<H>> {
    ...
    getDatabaseTradeGroupsAfterTradeId(marketName: string, adminTex: AdminTex<H, any>, afterTradeId: number): IterableIterator<DatabaseTrade<H>[]>;
    getDatabaseTradeGroupsAfterTime(marketName: string, adminTex: AdminTex<H, any>, afterTime: number): IterableIterator<DatabaseTrade<H>[]>;
