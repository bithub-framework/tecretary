...
class Tecretary extends Startable {
    ...
    async _start() {
        ...
        this.context = new Context(this.texchange, this.config, this.forward.setTimeout, this.forward.clearTimeout, this.forward.sleep, this.forward.now, this.forward.escape);
